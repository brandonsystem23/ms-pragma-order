package com.pragma.order_service.infrastructure.exceptionhandler;
...
class GlobalExceptionHandlerTest {
    ...
    void setUp() {
        ...
        mockServerWebExchange = MockServerWebExchange.from(
    ...
    void shouldHandleValidationError() {
        ...
        ResponseEntity<ErrorResponse> response = globalExceptionHandler.handleDomainException(ex, mockServerWebExchange);
    ...
    void shouldHandleExternalServiceException() {
        ...
        ResponseEntity<ErrorResponse> response = globalExceptionHandler.handleExternalServiceException(ex, mockServerWebExchange);
